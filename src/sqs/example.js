...
export const exampleA = {
  "meta": {
    ...
    "formSlug": "get-a-stove-or-other-appliance-certified-for-use-in-smoke-control-areas",
    "status": "draft",
    "isPreview": true,
      ...
      "LbZxXf": [
        {
          ...
          "NGfXVf": "If other, what fuel types will the appliance be certified to burn? (optional) test 1"
        }
      ]
    },
    "files": {}
...
export const resultA = {
  ...
  "instructionManual": {
    "instructionManualTitle": "If other, what fuel types will the appliance be certified to burn? (optional) test 1",
